    ...
    <div class="row">
        <div class="full-row top-bar py-2 bg-secondary">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="dashboard-top-left"> <a class="float-left dashboard-logo mr-4" href="index-1.html"><img src="images/logo/logo-icon.png" alt=""></a>
                    ...
                    <div class="col-lg-4">
                        <div class="dashboard-top-right float-left float-lg-right mt-2 mt-lg-0">
                            ...
                            <div class="dropdown float-left"> <a class="dropdown-toggle text-white" href="#" role="button" id="dropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="images/team/p.jpeg" alt=""> Zaenal Abidin </a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="accordion mt-4" id="accordionExample">
                                                        <form action="<?php echo base_url(). 'kost/lantai_1' ?>"  enctype="multipart/form-data" method="post">
                                                      ...
                                                      <div class="col-md-12 col-xl-12">
                                                          <div class="row">
                                                              <div class="dashboard-panel w-100">
                                                                  ...
                                                                  <input type="file" class="dropify" id="images" name="foto_kamar1"  multiple required="required" />
                                                                   <br>
                                                                </div>
                                                                    </div>
                                                                          ...
                                                                          <div class="property-location mt-4">
                                                                            ...
                                                                            <hr>
                                                                              <div class="row">
                                                                                  ...
                                                                                  <div class="col-sm-3">
                                                                                      <div class="form-group">
                                                                                          <input type="text" name="perkamar" class="form-control" placeholder="PerTahun">
                                                                                      </div>
                                                                                  </div>
                                                                              </div>
                                                                          </div>
                                                        ...
                                                        <form action="<?php echo base_url(). 'kost/lantai_2' ?>"  enctype="multipart/form-data" method="post">
                                                        ...
                                                        <form action="<?php echo base_url(). 'kost/lantai_3' ?>"  enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div id="collapsefour" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                                                                    ...
                                                                    <div class="dashboard-panel w-100">
                                                                        ...
                                                                        <div class="submit-form p-5 bg-white">
                                                                          <div class="row">
                                                                            <div class="col-md-12"> </div>
                                                                            <div class="col-md-12">
                                                                          <?php form_open_multipart('kost/lantai_4'); ?>
                                                                        <img id="image-preview" alt="image preview"/><br/>
                                                                        <input type="file" class="dropify" id="images" name="foto_kamar1"  multiple required="required" />
                                                                         <br>
                                                                      </div>
                                                            ...
                                                            <button type="button" class="btn btn-success btn-block">Tambah</button>
                                                            </div>
                                                            <?php form_close(); ?>
                                                                ...
                                                                <div class="col-md-12">
                                                                  <div class="row">
                                                                    <div class="dashboard-panel w-100">
                                                                        ...
                                                                        <div class="submit-form p-5 bg-white">
                                                                          <div class="row">
                                                                            <?php form_open_multipart('kost/lantai_5'); ?>
                                                                            <div class="col-md-12">
                                                                        <img id="image-preview" alt="image preview"/><br/>
                                                                        <input type="file" class="dropify" id="images" name="foto_kamar1"  multiple required="required" />
                                                                         <br>
