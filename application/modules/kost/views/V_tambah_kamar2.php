                            ...
                            <div class="dashboard-panel w-100">
                                ...
                                <div class="submit-form p-5 bg-white">
                                  <center><h5 class="text-secondary mb-5">Tambahkan Kamar Sesuai Denah Lantai </h5></center>
                                    <form method="post" action="<?php echo base_url().'kost/input_kamar' ?>">
                                        <div class="property-plan mt-4">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="accordion mt-4" id="accordionExample">
                                                        ...
                                                        <div id="collapseOne" class="collapse show p-4" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                            ...
                                                            <label for="combo">Berapa Jumlah Kamar Yang Ada ?</label>
                                                            <select class="form-control" id='combo'>
                                                              ...
                                                              <div id="myOptionsDiv" style="width: 100%;">  </div>
                                                        </div>
                                                        ...
                                                        <div id="collapseTwo" class="collapse p-4" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                  <label for="combo">Berapa Jumlah Kamar Yang Ada ?</label>
                                                            <select class="form-control" id='comboo'>
                                                              <option>0</option>
                                                              <option>1</option>
                                                              <option>2</option>
                                                              <option>3</option>
                                                              ...
                                                              <div id="myOptionDiv" style="width: 100%;">  </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="collapseThree" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                  <label for="combooo">Berapa Jumlah Kamar Yang Ada ?</label>
                                                            <select class="form-control" id='combooo'>
                                                              <option>0</option>
                                                              <option>1</option>
                                                              <option>2</option>
                                                              <option>3</option>
                                                              ...
                                                              <div id="myOptionsDivv" style="width: 100%;">  </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="collapsefour" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                  <label for="comb">Berapa Jumlah Kamar Yang Ada ?</label>
                                                            <select class="form-control" id='comb'>
                                                              ...
                                                              <div id="myOptionsDivb" style="width: 100%;">  </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                         ...
                                         <div class="col-md-4"><input type="file" class="dropify" id="images" name="foto_kamar"  multiple/></div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-success">Tambah</button>
                                    ...
                                    <br>
                                    <button class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#tambahkmr">Tambah</button>
                                </div>
                            </div>
...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
    ...
    for(var i = 0; i < num; i++){
      $('#myOptionsDiv').append(
        '</br><div class="dashboard-panel w-100"> <h4 class="text-secondary mb-4">Tambah kamar </h4> <div class="submit-form p-5 bg-white"> <div class="row"> <div class="col-md-12"> </div> <div class="col-md-12"><div class="col-md-4"><input type="file" class="dropify" id="images" name="foto_kamar"  multiple/></div><br> </div> </div> <div class="description"> <div class="row"> <div class="col-lg-12 col-md-12"> <div class="form-group"> <label>Nama Kamar :</label> <input type="text" name="nama_kamar" class="form-control"> </div> </div> <div class="col-sm-3 col-sm-3"> <div class="form-group"> <label>Ukuran Kamar :</label> <input type="text" name="ukuran_kamar" class="form-control" placeholder="_ X _"> </div> </div> <div class="col-lg-6 col-md-12"> <div class="form-group"> <label>Tipe Kost :</label> <select class="form-control" name="gender"> <option></option> <option value="laki-laki">Laki - Laki</option> <option value="wanita">Wanita</option> </select> </div> </div> <div class="col-lg-3"> </div> </div> </div> <div class="description mt-4"> <h5 class="text-secondary">Deskripsi</h5> <hr> <div class="row"> <div class="col-lg-12 col-md-12"> <div class="form-group"> <label>Deskripsi</label> <textarea class="form-control bg-gray" placeholder="Write Details..." rows="6" name="deskripsi_kamar"></textarea> </div> </div> </div> </div> <div class="property-location mt-4"> <h5 class="text-secondary">Harga</h5> <hr> <div class="row"> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="perhari" placeholder="PerHari" class="form-control"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="perminggu" class="form-control" placeholder="PerMinggu"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="perbulan" placeholder="PerBulan" class="form-control"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="perkamar" class="form-control" placeholder="PerTahun"> </div> </div> </div> </div> <div class="additional-feature mt-4"> <h5 class="text-secondary mb-3">Fitur Tambahan :</h5> <div class="row"> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="kulkas" name="kulkas"> <label class="custom-control-label" for="kulkas">kulkas</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="mesincuci" name="mesincuci"> <label class="custom-control-label" for="mesincuci">Mesin Cuci</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="sofa" name="sofa"> <label class="custom-control-label" for="sofa">Sofa</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="wifi" name="wifi"> <label class="custom-control-label" for="wifi">Wifi</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="Listrik" name="Listrik"> <label class="custom-control-label" for="Listrik">Listrik</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="parkir_mobile" name="parkir"> <label class="custom-control-label" for="parkir_mobile">Kasur</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="air" name="air"> <label class="custom-control-label" for="air">Air</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="lemari" name="ac"> <label class="custom-control-label" for="lemari">Lemari</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="kasur" name="ac"> <label class="custom-control-label" for="kasur">Kamar Mandi</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="tv" name="tv"> <label class="custom-control-label" for="tv">TV</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="heater" name="tv"> <label class="custom-control-label" for="heater">Water Heater</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="dapur" name="tv"> <label class="custom-control-label" for="dapur">Dapur</label> </div> </div> </div> </div> </div> </div>'
        );
      }
  });
    </script>
    ...
    for(var l = 0; l < nu; l++){
      $('#myOptionDiv').append(
        '</br><div class="col-lg-12 col-xl-12"> <div class="row"> <div class="dashboard w-100"> <h4 class="text-secondary mb-4">Tambah Kamar :</h4> <div class="submit-form p-5 bg-white"> <div class="row"> <div class="col-md-2"> </div> <div class="col-md-6"> <div class="browse-submit"> <input type="file" id="fileupload-example-1" class="d-none"> <label class="fileupload-label text-center w-100" for="fileupload-example-1">Foto Kost</label> </div> <br> </div> </div> <form> <div class="description"> <div class="row"> <div class="col-lg-12 col-md-12"> <div class="form-group"> <label>Nama Kamar :</label> <input type="text" name="title" class="form-control"> </div> </div> <div class="col-sm-2 col-sm-2"> <div class="form-group"> <label>Ukuran :</label> <input type="text" name="title" class="form-control" placeholder="_ X _"> </div> </div> <div class="col-lg-6 col-md-12"> <div class="form-group"> <label>Tipe Kost :</label> <select class="form-control"> <option></option> <option>Laki - Laki</option> <option>Wanita</option> </select> </div> </div> <div class="col-lg-3"> </div> </div> </div> <div class="description mt-4"> <h5 class="text-secondary">Deskripsi</h5> <hr> <div class="row"> <div class="col-lg-12 col-md-12"> <div class="form-group"> <label>Deskripsi</label> <textarea class="form-control bg-gray" placeholder="Write Details..." rows="6"></textarea> </div> </div> </div> </div> <div class="property-location mt-4"> <h5 class="text-secondary">Harga</h5> <hr> <div class="row"> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="title" placeholder="PerHari" class="form-control"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="title" class="form-control" placeholder="PerMinggu"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="title" placeholder="PerBulan" class="form-control"> </div> </div> <div class="col-sm-3"> <div class="form-group"> <input type="text" name="title" class="form-control" placeholder="PerTahun"> </div> </div> </div> </div> <div class="additional-feature mt-4"> <h5 class="text-secondary mb-3">Fitur Tambahan :</h5> <div class="row"> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="kulkas" name="kulkas"> <label class="custom-control-label" for="kulkas">kulkas</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="mesincuci" name="mesincuci"> <label class="custom-control-label" for="mesincuci">Mesin Cuci</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="sofa" name="sofa"> <label class="custom-control-label" for="sofa">Sofa</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="wifi" name="wifi"> <label class="custom-control-label" for="wifi">Wifi</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="Listrik" name="Listrik"> <label class="custom-control-label" for="Listrik">Listrik</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="parkir_mobile" name="parkir"> <label class="custom-control-label" for="parkir_mobile">Kasur</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="air" name="air"> <label class="custom-control-label" for="air">Air</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="lemari" name="ac"> <label class="custom-control-label" for="lemari">Lemari</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="kasur" name="ac"> <label class="custom-control-label" for="kasur">Kamar Mandi</label> </div> </div> <div class="col-lg-3"> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="tv" name="tv"> <label class="custom-control-label" for="tv">TV</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="heater" name="tv"> <label class="custom-control-label" for="heater">Water Heater</label> </div> <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="dapur" name="tv"> <label class="custom-control-label" for="dapur">Dapur</label> </div> </div> </div> </div> </form> <br></div> </div> </div> </div>'
        );
      }
  });
    </script>
