        ...
        <div class="row about-company">
            <div class="col-md-12 col-lg-7">
                <div class="about-content"><?php echo $res->konten ?>
                   <!--  <p>Rajakost memanfaatkan teknologi dengan mengelola dan menyajikan daftar kos dengan penjelasan fasilitas secara terperinci dan dilengkapi dengan foto serta detail dari setiap kos. Kami memiliki tim, yang tugasnya mengecek dan membuat profil setiap properti. Temukan properti dengan tanda sebagai properti yang sudah dicek oleh tim kami!</p>
                    <p>Rajakost telah menghubungkan lebih dari 110 ribu pemilik kos dengan 6-8 juta pencari kos setiap bulannya, untuk memberikan akomodasi yang lebih baik. Inovasi yang kami lakukan bertujuan untuk memberikan kenyamanan dan kemudahan bagi penyewa dan pemilik kos.</p> -->
