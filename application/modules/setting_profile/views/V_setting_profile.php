                        ...
                        <div class="row">
                            <div class="dashboard-panel w-100">
                                ...
                                <div class="dashboard-personal-info p-5 bg-white">
                                    <form action="<?php echo base_url().'setting_profile/edit'; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-11 col-xl-10">
                                <div class="row">
                                    <div class="dashboard-panel w-100">
                                        ...
                                        <div class="dashboard-personal-info p-5 bg-white">
                                            <form action="<?php echo base_url().'setting_profile/password';?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id_user" value="<?php echo $key->id_user; ?>">
                                                    <div class="col-lg-6 col-md-12">
