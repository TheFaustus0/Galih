        ...
        ===============================================================-->
            ...
            <div class="container">
                <div class="col-md-5" style="margin-left: 40%;">
                    <div class="col-md-6">
                        <h4 class="page-name float-left text-secondary mt-1 mb-0">Login Pemilik</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5" style="margin-left: 30%;">
                        <div class="mt-sm-50"> <a href="login-pemilik.html" class="down-active text-secondary mr-3">Login</a>
                            </li>
                            <a href="<?php echo base_url().'login/register_pemilik' ?>" class="text-secondary">Register</a>
                            <form class="mt-5 icon-form" action="<?php echo base_url().'login/login_aksi_pemilik' ?>" method="post">
                                <div class="form-group user">
                                    <label for="exampleInputEmail1">Nomor Telepon</label>
                                    <input id="exampleInputEmail1" name="no_telp" type="text" class="form-control bg-gray" placeholder="Nomor Telepon">
                                </div>
                                <div class="form-group password">
                                    <label for="exampleInputPassword1">Password</label>
                                    <input id="exampleInputPassword1" name="password" type="password" class="form-control bg-gray" placeholder="Password">
                                </div>
                                <button class="btn btn-primary btn-block">login</button>
                                <a href="index-1.html" class="btn btn-danger btn-block">Kembali</a>
                                <a class="text-secondary hover-text-primary d-block mt-4" href="#">Lupa Password ?</a>
                                 <br>
                                <p style="color: red;">Jika Belum Mempunyai Akun Harap Klik Register Terlebih Dahulu ?</p>
                            </form>
                        </div>
                    </div>
                </div>
