        ...
        <div class="bg-gray full-row py-5 page-banner">
            <div class="container">
                <div class="col-md-5" style="margin-left: 39%;">
                    <div class="col-md-6">
                        <h4 class="page-name float-left text-secondary mt-1 mb-0">Register Penyewa</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5" style="margin-left: 30%;">
                        <div class="mt-sm-50"><!--  <a href="login-pemilik.html" class="text-secondary mr-3">Login</a> -->
                            ...
                            <form class="mt-5 icon-form" method="post" action="<?php echo base_url().'login/aksi_register_penyewa' ?>">
