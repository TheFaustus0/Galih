        ...
        ===============================================================-->
            ...
            <div class="container">
                <div class="col-md-5" style="margin-left: 40%;">
                    <div class="col-md-6">
                        <h4 class="page-name float-left text-secondary mt-1 mb-0">Login Penyewa</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5" style="margin-left: 30%;">
                        <div class="mt-sm-50"> <a href="login-pemilik.html" class="down-active text-secondary mr-3">Login</a>
                            ...
                            <a href="<?php echo base_url().'login/register_penyewa' ?>" class="text-secondary">Register</a>
                            <form class="mt-5 icon-form" action="<?php echo base_url().'login/login_aksi_penyewa' ?>" method="post">
