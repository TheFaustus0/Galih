       ...
       <div class="full-row dashboard py-0  bg-gray">
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="dashboard-sidebar flat-small py-4 w-100">
                                ...
                                <ul class="mb-4 text-white">
                                    <li class="active"><a href="dashboard-massanger-pemilik.html"><i class="flaticon-dashboard mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Dashboard</span></a></li>
                                ...
                                <ul class="mb-4 text-white">
                                    <li class=""><a href="dashboard-booking-pemilik.html"><i class="flaticon-calendar mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Kos Yang Tersewa</span></a></li>
                                    ...
                                    <li class=""><a href="dashboard-submit-property.html"><i class="flaticon-forward mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Tambah Kost</span></a></li>
                                 </ul>
                                ...
                                <ul class="mb-4 text-white">
                                    ...
                                    <li><a href="dashboard-system-setting-pemilik.html"><i class="flaticon-settings mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Pengaturan</span></a></li>
                    ...
                    ?>
                            <!-- <div class="dashboard-copyright bg-white py-4 text-center w-100">© 2020 Raja Kost</div> -->
                        </div>
                    </div>
                </div>
            </div>
