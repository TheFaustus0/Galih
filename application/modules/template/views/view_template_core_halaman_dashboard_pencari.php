...
<!-- Mirrored from unicoderbd.com/theme/html/homex/dashboard-system-setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2020 03:31:21 GMT -->
<head>
<!-- Required meta tags -->
<meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="dashboard-top-left"> <a class="float-left dashboard-logo mr-4" href="index-1.html"><img src="assets/images/logo/logo-icon.png" alt=""></a>
                            ...
                            <div class="d-flex"> <a class="text-primary hover-text-primary mr-4 font-18" href="#"><i class="fas fa-bell"></i><sup class="text-white">10</sup></a> <a class="text-primary hover-text-primary mr-4 font-18" href="#"><i class="fas fa-comments"></i><sup class="text-white">5</sup></a> </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="dashboard-top-right float-left float-lg-right mt-2 mt-lg-0">
                            <div class="text-white float-left mr-4"></span></div>
                            <div class="dropdown float-left"> <a class="dropdown-toggle text-white" href="#" role="button" id="dropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="assets/images/team/p.jpeg" alt=""> Zaenal Aladin </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2"> <a class="dropdown-item" href="dashboard-personal-info.html">Profile</a> <a class="dropdown-item" href="index-1.html">keluar</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-1 col-xl-2 bg-secondary">
                        <div class="row">
                            <div class="dashboard-sidebar flat-small py-4 w-100">
                                <h6 class="text-primary border-bottom-gray pb-3 my-2 pl-3 d-md-none d-xl-block">Halaman Saya</h6>
                                ...
                                <h6 class="text-primary border-bottom-gray pb-3 my-2 pl-3 d-md-none d-xl-block">Kelolah Kost</h6>
                                <ul class="mb-4 text-white">   
                                    ...
                                    <li><a href="Pembayaran.html"><i class="flaticon-money bag mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Pembayaran</span></a></li>
                                </ul>
                                <h6 class="text-primary border-bottom-gray pb-3 my-2 pl-3 d-md-none d-xl-block">Pengaturan</h6>
                                <ul class="mb-4 text-white">
                                    <li><a href="dashboard-personal-info.html"><i class="flaticon-seller mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Info Profil</span></a></li>
                                    <li><a href="dashboard-system-setting.html"><i class="flaticon-settings mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Settings</span></a></li>
                                    <li><a href="dashboard-cara-pembookingan.html"><i class="flaticon-resume mr-3 mr-md-0 mr-xl-3"></i><span class="d-md-none d-xl-block">Cara Pembookingan</span></a></li>
