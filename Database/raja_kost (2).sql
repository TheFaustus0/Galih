...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2020 at 09:30 AM
...
INSERT INTO `t_kamar` (`id_kamar`, `nama_kamar`, `ukuran`, `tipe_kost`, `deskripsi`, `perhari`, `perminggu`, `perbulan`, `pertahun`, `lantai`) VALUES
(37, '', 0, '', '', 0, 0, 0, 0, 1),
(38, '', 0, '', '', 0, 0, 0, 0, 1);
...
INSERT INTO `t_kost` (`id_kost`, `id_fasilitas_kost`, `id_foto_kost`, `id_lantai`, `id_rumah_sakit`, `id_super_market`, `id_sekolah`, `id_rumah_makan`, `nama_kost`, `tahun_dibangun`, `deskripsi`, `tipe_kost`, `alamat_kost`) VALUES
(168, 168, 168, 168, 168, 168, 168, 168, 'dfdfdsfsd', 1988, 'xccjhgfadfljsdglfg', 'dsfsf', 'wdefe'),
(170, 0, 0, 0, 0, 0, 0, 0, 'jlhjhvh', 0, '', '', '');
...
(20, 'Anjing', 258, '123456', 'default.png', 1),
(21, 'Babi Nge W', 147, '123456', 'default.png', 2),
(22, 'Kucing vs Anjink', 123, '123456', 'default.png', 1);
...
CREATE TABLE `t_rumah_makan` (
  `id_rumah_makan` int(11) NOT NULL,
  `nama_tempat_makan` varchar(200) NOT NULL,
  `jarak_makan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_rumah_makan` (`id_rumah_makan`, `nama_tempat_makan`, `jarak_makan`) VALUES
(168, 'asdsd', 45);
...
CREATE TABLE `t_rumah_sakit` (
  `id_rumah_sakit` int(11) NOT NULL,
  `nama_tempat_sakit` varchar(100) NOT NULL,
  `jarak_sakit` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_rumah_sakit` (`id_rumah_sakit`, `nama_tempat_sakit`, `jarak_sakit`) VALUES
(168, 'asdsd', 45);
...
CREATE TABLE `t_sekolah` (
  `id_sekolah` int(11) NOT NULL,
  `nama_tempat_sekolah` varchar(100) NOT NULL,
...
INSERT INTO `t_sekolah` (`id_sekolah`, `nama_tempat_sekolah`, `jarak_sekolah`) VALUES
(168, 'asdsd', 45);
...
CREATE TABLE `t_super_market` (
  `id_super_market` int(11) NOT NULL,
  `nama_tempat_market` varchar(100) NOT NULL,
  `jarak_market` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_super_market` (`id_super_market`, `nama_tempat_market`, `jarak_market`) VALUES
(168, 'asdsd', 45);
...
--
ALTER TABLE `fasilitas_kost`
  MODIFY `id_fasilitas_kost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;

--
-- AUTO_INCREMENT for table `foto_kamar`
--
ALTER TABLE `foto_kamar`
  MODIFY `id_foto_kamar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;

--
-- AUTO_INCREMENT for table `foto_kost`
--
ALTER TABLE `foto_kost`
  MODIFY `id_foto_kost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `t_kost`
  MODIFY `id_kost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT for table `t_lantai`
--
ALTER TABLE `t_lantai`
  MODIFY `id_lantai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `t_rumah_makan`
  MODIFY `id_rumah_makan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;

--
-- AUTO_INCREMENT for table `t_rumah_sakit`
--
ALTER TABLE `t_rumah_sakit`
  MODIFY `id_rumah_sakit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `t_super_market`
  MODIFY `id_super_market` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
